...
if __name__ == '__main__':
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        f1 = executor.submit(do_something, 2)  # submit() schedule process and return future object
        f2 = executor.submit(do_something, 2)  # submit() schedule process and return future object
